...
def main():
    ...
    noEsta = pygame.mixer.Sound("noEsta.mp3")
        ...
        for e in pygame.event.get():
            ...
            if e.type == pygame.KEYDOWN or e.type == KEYDOWN:
                ...
                if usuarioModalidad == "a":
                    ...
                    dibujar(screen, ListaDePalabrasUsuario, palabraUsuario, puntos, segundos, gano, correctas, incorrectas, casi, palabraCorrecta)
                                    ...
                                    if len(palabraUsuario) != len(palabraCorrecta):
                                        ...
                                        if gano:
                                            ...
                                            if palabraUsuario not in listaPalabrasDiccionario:
                                                pygame.mixer.Sound.play(fail)
                                                pygame.mixer.music.stop()
                                                pygame.mixer.Sound.play(noEsta)
                                                pygame.mixer.music.stop()
                                            else:
                            ...
                            if e.type == KEYDOWN:
                                ...
                                if e.key == K_RETURN:
                                    if len(palabraUsuario) != len(palabraCorrecta):
                                        ...
                                        correcta = revision(palabraCorrecta, palabraUsuario, correctas, incorrectas, casi)
                                        if correcta == True:
                                            pygame.mixer.Sound.play(victory)
                                            puntos += 1
                                            palabraUsuario = ""
                ...
                if usuarioModalidad == "c":
                    pygame.mixer.music.stop()
                    usuarioModalidad = ""
                    #lectura del diccionario
                    lecturaAleatoria(archivo, listaPalabrasDiccionario)
